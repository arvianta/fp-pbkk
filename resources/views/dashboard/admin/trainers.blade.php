                ...
                <div class="">
                    ...
                    <div class="block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5  ">
                        <div class="w-full mb-1">
                            <div class="mb-4">
                                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl ">All Trainer</h1>
                            </div>
                    ...
                    <!-- Add Class Drawer -->
                    <div id="drawer-create-class-default" class="fixed top-0 right-0 z-50 w-full h-screen max-w-xs p-4 overflow-y-auto transition-transform translate-x-full bg-white " tabindex="-1" aria-labelledby="drawer-label" aria-hidden="true">
                        ...
                        <form method="post" action="{{ route('personaltrainer.create') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                            @csrf
                            @method('post')
                            <div class="space-y-4">
                                <div>
                                    <label for="name" class="block mb-2 text-sm font-medium text-gray-900 ">Name</label>
                                    <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5      " placeholder="Enter Name" required="">
                                </div>

                                <div>
                                    <label for="session_cost" class="block mb-2 text-sm font-medium text-gray-900 ">Session Cost</label>
                                    <input type="number" name="session_cost" id="session_cost" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5      " placeholder="$2999" required="">
                                </div>
                                <div>
                                    <label for="certification" class="block mb-2 text-sm font-medium text-gray-900">Certification</label>
                                    <textarea name="certification" id="certification" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Enter certification here"></textarea>
                                </div>
