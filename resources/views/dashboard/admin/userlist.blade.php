<x-app-layout>
    ...
    <div>
        ...
        <div class="mx-auto px-8 overflow-x-auto lg:px-56 md:px-14 pt-8 sm:ml-64">
            <form action="{{ route('admin.userlist') }}" method="get" class="w-full inline-block">   
                ...
                <div class="relative">
                    ...
                    <input type="search" name="query" id="default-search" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-primary focus:border-primary" placeholder="Search here..." required>
                    <input type="hidden" name="sort_by" value="{{ $sort_by }}">
                    <button type="submit" class="text-dark3 absolute right-2.5 bottom-2.5 bg-primary/80 hover:bg-primary focus:ring-4 focus:outline-none focus:ring-primary/60 font-medium rounded-lg text-sm px-4 py-2">Search</button>
                </div>
            </form>
        </div>
        <div class="sm:ml-64">
